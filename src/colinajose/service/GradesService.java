...
public class GradesService {
    ...
    private static boolean setScholarShipStudents(double scholarshipGrade){
    ...
    private static void setExpelledStudents(double expelledGrade){
    ...
    private static void setNotifyStudents(double expelledGrade, double notifyGrade){
    ...
    private static void setAverageStudents(double notifyGrade, double scholarshipGrade){
